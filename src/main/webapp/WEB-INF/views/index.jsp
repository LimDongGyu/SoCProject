...
<ul class="nav nav-pills">
    <li class="nav-item">
        <a class="nav-link active" id="topBtn" onclick="javascript:window.scrollTo(0,40);">지역으로 찾기</a>
    </li>
    <li class="nav-item">
        <a class = "nav-link active" id="bottomBtn" onclick="javascript:window.scrollTo(0,1700);">이름으로 찾기 </a>
    </li>
</ul>
<script>
</script>
    ...
    <div class="justify-content-md-center">
        <div class="col-sm-10">
            ...
            <script>
                ...
                var link_url_asLoca = null;
                var link_url_asName = null;
                ...
                function categoryChange(e) {
                    ...
                    link_url_asLoca = "/MineralSpring/AsLocation?location="+Location.toString()+"&time="+time.toString()+"&date="+date.toString();

                }
                function go(){
                    window.location.href = link_url_asLoca;
                }
            </script>
                <br/>
                <br/>
            ...
            <div class="col-sm-10">
                <div class="jumbotron" id="down">
                    ...
                    <div class="form-group">
                        <label class="col-form-label" for="inputDefault">약수터 이름으로 검색</label>
                        <input type="text" class="form-control" placeholder="약수터 이름을 넣어주세요" id="inputDefault">
                        <script></script><br/>
                        <br/>
                        <br/>
                        <script>
                                ...
                                function go2(){
                                    var Name = document.getElementById("inputDefault").value;
                                    link_url_asName = "/MineralSpring/AsSpring?springNameEx="+Name.toString()+"&time="+time.toString()+"&date="+date.toString();
                                    window.location.href = link_url_asName;
                                }

                        </script>
                        <a href="javascript:void(0);" onclick="go2(); return false;"> <button class="btn btn-info"role="button"> 찾기 </button> </a>
                    </div>
                </div>
            </div>
        </div>
